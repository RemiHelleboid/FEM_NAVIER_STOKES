...
int  main(int argc, const char** argv)
{
    ...
    vector<int> ListIndexP(Th.nt), ListIndexU(Th.nt*6);
    ...
    hashMatrix  DataMatrix(dimension_total), DataM(dimension_total);
    ...
    ExportSolution(Th, offset, BDofK, Bnum, Pressure, Velocity, "check41.data");
